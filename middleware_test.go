...
func TestUnmarshalCaddyfile(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input:         "wake_on_lan CC:C4:45:32:7A:51 192.168.1.255:9 0",
			expectedMAC:   "CC:C4:45:32:7A:51",
			expectedBcast: "192.168.1.255:9",
...
func TestProvisionNoTimeout(t *testing.T) {
	...
	// Run Provision to make sure missing timeout doesn't error out
